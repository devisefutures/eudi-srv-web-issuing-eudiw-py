...
class ConfService:
    ...
    service_url = "https://eudiw-issuer.ama.projj.eu/"

    wallet_test_url = "https://wallet-tester.eudiw-issuer.ama.projj.eu/"
    ...
    sample_data = {
        "family_name": "Nome_família",
        "given_name": "Nome_próprio",
    ...
    log_dir = "/var/log/eudiw-issuer"
    # log_dir = "../../log"
    log_file_info = "eudiw-issuer.log"
